...
class Manager
{
	...
	public:
		std::vector<std::string> _chanoper; // changed the name to chanop > more accurate. Public cuse no need to be private and helps.
		...
		void	parseCommands(std::vector<Clients>::iterator iter, char *buffer, int read);
};
